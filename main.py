...
from app.routes.router_viewer import router_viewer
from app.routes.router_dev import router_dev
...
app.include_router(router_viewer,prefix="/viewer",tags=["Viewer"])
app.include_router(router_dev,prefix="/dev",tags=["Dev"])
